...
print("======================================================================")
print("STAGE 5 — EXPERIMENT 5.3: STRUCTURED EDUCATION SUBSYSTEM EVALUATION")
print("======================================================================")
...
out_dir = PROJECT_ROOT / "output" / "ner" / "stage5_exp53_education"
...
print("\n======================================================================")
print("EXPERIMENT 5.3 EDUCATION SUBSYSTEM VERIFICATION SUMMARY")
print("======================================================================")
...
registry = {
    "experiment_id": "Exp 5.3 — Structured Education Extraction Subsystem",
...
with open(PROJECT_ROOT / "stage5_exp53_experiment_registry.json", "w", encoding="utf-8") as f:
    json.dump(registry, f, indent=2)

authoritative_out = {
    "experiment": "Stage 5 Experiment 5.3 Education Subsystem",
    "education_fields": ["DEGREE", "INSTITUTION", "FIELD_OF_STUDY", "GRADUATION_YEAR", "CGPA"],
    "strict_dev_metrics": {
...
print("Saved experiment registry to 'stage5_exp53_experiment_registry.json'.")
