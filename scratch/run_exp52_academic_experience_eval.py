...
print("======================================================================")
print("STAGE 5 — EXPERIMENT 5.2: ACADEMIC EXPERIENCE SUBSYSTEM EVALUATION")
print("======================================================================")
...
out_dir = PROJECT_ROOT / "output" / "ner" / "stage5_exp52_academic_experience"
...
print("\n======================================================================")
print("EXPERIMENT 5.2 ACADEMIC EXPERIENCE SUBSYSTEM VERIFICATION SUMMARY")
print("======================================================================")
...
registry = {
    "experiment_id": "Exp 5.2 — Academic Experience & Research Subsystem",
...
with open(PROJECT_ROOT / "stage5_exp52_experiment_registry.json", "w", encoding="utf-8") as f:
    json.dump(registry, f, indent=2)

authoritative_out = {
    "experiment": "Stage 5 Experiment 5.2 Academic Experience Subsystem",
    "academic_fields": ["INSTITUTION", "JOB_TITLE", "RESEARCH_INTEREST", "EMPLOYMENT_DATES"],
    "strict_dev_metrics": {
...
print("Saved experiment registry to 'stage5_exp52_experiment_registry.json'.")
