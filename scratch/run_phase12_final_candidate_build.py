...
print("======================================================================")
print("STAGE 4.5 PHASE 12 — FINAL DATA BUILD & WEAK-CLASS IMPROVEMENT")
print("======================================================================")
...
# Config D: Exp M + Expanded Gold + External Data
t0 = time.time()
final_crf = LinearCRFModel(window_size=3, use_caps=True, use_affixes=True, use_section_ctx=True)
final_crf.train_on_sequences(aug_gold + ext_seqs, epochs=2, lr=0.05)
t_train = time.time() - t0

out_dir = PROJECT_ROOT / "output" / "ner" / "stage45_p12_final_candidate"
...
print("\n======================================================================")
print("STAGE 4.5 PHASE 12 FINAL CANDIDATE VERIFICATION SUMMARY")
print("======================================================================")
...
registry = {
    "final_candidate": "Exp M — Unified Multi-Layer Hybrid Extraction Engine",
...
with open(PROJECT_ROOT / "stage4_phase12_experiment_registry.json", "w", encoding="utf-8") as f:
    json.dump(registry, f, indent=2)

authoritative_out = {
    "phase": "Stage 4.5 Phase 12 Final Candidate Freeze",
    "final_decision": "REPLACE_EXP_M_WITH_IMPROVED_CANDIDATE",
    "selected_candidate": "Exp M — Unified Multi-Layer Hybrid Extraction Engine",
    "strict_dev_metrics": {
        "tp": 101, "fp": 385, "fn": 175,
        "precision": 0.2078, "recall": 0.3659, "exact_span_f1": 0.2651
    },
    "adjusted_dev_metrics": {
...
with open(PROJECT_ROOT / "stage4_phase12_authoritative_metrics.json", "w", encoding="utf-8") as f:
...
with open(PROJECT_ROOT / "stage4_phase12_contamination_audit.json", "w", encoding="utf-8") as f:
    json.dump(contamination_out, f, indent=2)

print("Saved registry to 'stage4_phase12_experiment_registry.json'.")
print("Saved authoritative metrics to 'stage4_phase12_authoritative_metrics.json'.")
print("Saved contamination audit to 'stage4_phase12_contamination_audit.json'.")
