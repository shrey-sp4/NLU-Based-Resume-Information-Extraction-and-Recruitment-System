...
test_pdfs = [
    ...
    PROJECT_ROOT / "data" / "real_resumes" / "original" / "Resume final Amit CMA IIM A.pdf"
]

print("======================================================================")
print("LIVE STAGE-BY-STAGE PIPELINE TEST ON 7 RESUMES")
print("======================================================================\n")
...
for pdf_path in test_pdfs:
    ...
    for sk_idx, sk_item in enumerate(skills_list[:6]):
